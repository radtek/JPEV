...
TCHAR STR_LICENSE[]                     = _T("Jack Portable Executable (PE) 32-bits file Viewer\r\n\r\n\
This product is implemented by Ngo Le Huy Hien, a student at the University of Da Nang, VN-UK Institute \
for Research and Executive Education.\r\n\r\n\
Since the product is initially created for INTERNAL USE ONLY, \
you ARE NOT ALLOWED to make this product public in any case. \
This is not a commercial product and would never be a commercial product, \
therefore, you are NOT ALLOWED to make this to be commercial \
as you are using this for free. \r\n\r\n\
For any improvements and cooperations with the author, please contact \
directly through his email: ngolehuyhien@gmail.com. \r\n\r\n\
...
You may not use the software or any content for any commercial purpose.");
